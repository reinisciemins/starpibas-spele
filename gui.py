...
def draw_outline( surface, rect, color, thickness = 1 ):
    pygame.draw.line( surface, color, ( rect.left, rect.top ), ( rect.left + rect.width, rect.top ), thickness ) # augseja linija
    pygame.draw.line( surface, color, ( rect.left, rect.top + rect.height ), ( rect.left + rect.width, rect.top + rect.height ), thickness ) # apakseja linija
    pygame.draw.line( surface, color, ( rect.left, rect.top ), ( rect.left, rect.top + rect.height ), thickness ) # kreisa linija
    pygame.draw.line( surface, color, ( rect.left + rect.width, rect.top ), ( rect.left + rect.width, rect.top + rect.height ), thickness ) # laba linija
...
def main( ):
    ...
    while running:
        ...
        if in_options:
            ...
            draw_button( screen, verdana, "-   Virknes garums: ", pygame.Rect( 449, 165, 240, 30 ), mouse, mouse_click, line_count, "   +" )
        ...
        if in_game:
            ...
            if player_starts == True:
                draw_text( screen, verdana, "Spēli sāk cilvēks - " + str( line_count ), pygame.Rect( 307, 420, 240, 30 ), ( 50, 50, 50 ) )
            else:
                draw_text( screen, verdana, "Spēli sāk dators - " + str( line_count ), pygame.Rect( 307, 420, 240, 30 ), ( 50, 50, 50 ) )
